class taSavingsCloudbedsDEQYTQ{
    OTASavingsBtn(){
    ...
    BookingUploadFiles(){
        return cy.get('#travel-agent-booking-upload-files-14647');
    }
    ExpediaButton(){
        return cy.get('#travel-agent-expedia-info-14647 > .btn-no-margin > .info-btn > .img');
    }
    ExpediaUploadFiles(){
        return cy.get('#travel-agent-expedia-upload-files-14647')
    }
    DeleteCheckBox(){
...
export default taSavingsCloudbedsDEQYTQ; 