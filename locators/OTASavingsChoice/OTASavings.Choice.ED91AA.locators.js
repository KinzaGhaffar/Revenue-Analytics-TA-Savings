class taSavingsChoiceED91AA{
    ...
    BookingUploadFiles(){
        return cy.get('#travel-agent-booking-upload-files-14406 > span');
    }
    ExpediaButton(){
        return cy.get('#travel-agent-expedia-info-14406 > .btn-no-margin > .info-btn > .img');
    }
    ExpediaUploadFiles(){
        return cy.get('#travel-agent-expedia-upload-files-14406 > span');
    }
    DeleteCheckBox(){
...
export default taSavingsChoiceED91AA;
